...
def _phase_a_prompt(fd_path, rid):
    ...
    return (
        ...
        "  • DIGITAL BRAIN — Layer 4 (client document RAG): call search_brain with the requirement\n"
        "    summary to surface relevant context from harvested client documents (SharePoint FDs, TDs,\n"
        ...
        "  • DIGITAL BRAIN — Layer 4 (client design docs): call search_brain(query='<capability + the\n"
