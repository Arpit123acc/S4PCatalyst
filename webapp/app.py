...
def _phase_c_prompt(rid, fd_path, decision, notes, fc_txt, cp2_slug, is_sbpa=False):
    ...
    return (
        ...
        "     Also state: extensibility_approach (KEY_USER…KU_DEV_SXS); the in-scope component arrays\n"
        "     (key_user_components / developer_components / btp_components); transport_type; and\n"
        "     dev_entitlement_required (call it out as a pre-condition whenever developer is in scope).\n\n"
