...
2. **Structural review** —
   ...
   - Side-by-side (CAP / UI5 / Node / JS): review against the authoritative docs — CAP
     https://cap.cloud.sap/docs/, SAP UI5 https://ui5.sap.com/, Node.js
     https://nodejs.org/docs/latest/api/, JavaScript https://www.w3schools.com/js/default.asp,
     npm https://www.npmjs.com/package/npm, SAP Community https://community.sap.com/.
