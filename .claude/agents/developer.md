...
- When building side-by-side (BTP) or UI/JS code, follow the authoritative developer docs (also in `get_reference_links`): CAP https://cap.cloud.sap/docs/ · SAP UI5 https://ui5.sap.com/ · Node.js https://nodejs.org/docs/latest/api/ · JavaScript https://www.w3schools.com/js/default.asp · npm https://www.npmjs.com/package/npm · SAP Community https://community.sap.com/.
